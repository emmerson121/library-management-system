      ...
      >
        ...
        >
          ...
          <p style={{ margin: "6px 0 0", color: "#c4b5fd", fontSize: "13px" }}>
            {mode === "login"
              ? "Sign in to borrow and manage your loans."
              : "Join Meridian Library to start borrowing books."}
          </p>
        </div>
...
const labelTextStyle: React.CSSProperties = { fontSize: "12px", fontWeight: 700, color: "#4a3f72", letterSpacing: "0.04em", textTransform: "uppercase" };
    ...
    <div style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{
          ...
          boxShadow: "0 12px 40px rgba(30,20,60,0.18)",
          ...
          <div style={{ padding: "10px 10px" }}>
            <div style={{
              ...
              background: loanCount > 0 ? "#f5f0ff" : "transparent",
            }}>
              ...
              <div>
                ...
                {loanCount > 0 && (
                  <div style={{ fontSize: "11px", color: "#7c6f99" }}>Return within 14 days</div>
                )}
              </div>
            </div>
            <button
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <span style={{
          fontSize: "11px", fontWeight: 600, color: "#7c5cbf",
          background: "#f3eeff", padding: "3px 10px", borderRadius: "20px",
          letterSpacing: "0.04em", marginRight: isMyLoan ? "68px" : "0",
        }}>
          {book.genre}
        </span>
      </div>
        ...
        {isMyLoan ? (
          <button
            ...
            style={{
              ...
              background: "#fff", color: "#7c5cbf",
              transition: "all 0.15s",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLButtonElement).style.background = "#7c5cbf";
              (e.currentTarget as HTMLButtonElement).style.color = "#fff";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLButtonElement).style.background = "#fff";
              (e.currentTarget as HTMLButtonElement).style.color = "#7c5cbf";
            }}
          >
            Return
          </button>
...
export default function LibraryApp() {
  ...
  const handleBorrow = (id: number) => {
    ...
    setUser((prev) => prev ? { ...prev, loans: [...prev.loans, id] } : prev);
    showNotification(`"${book.title}" added to your loans. Return within 14 days.`);
  };
    ...
    <div style={{ minHeight: "100vh", background: "#f5f2fb", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      {notification && (
        <div style={{
          ...
          background: notification.type === "info" ? "#3b2a7e" : "#1e143c",
          color: "#fff",
          padding: "14px 22px", borderRadius: "12px",
          boxShadow: "0 8px 30px rgba(30,20,60,0.25)",
          fontSize: "14px", maxWidth: "340px",
          ...
          <div style={{
            ...
            <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", gap: "10px", justifyContent: "center" }}>
              ...
              <span style={{ color: "#c4b5fd", fontSize: "13px" }}>
                ...
                <button
                  onClick={() => setShowAuth(true)}
                  style={{ background: "none", border: "none", color: "#a78bfa", fontWeight: 700, cursor: "pointer", padding: 0, fontSize: "13px", textDecoration: "underline" }}
                >
                  Log in or sign up
                </button>
                {" "}to borrow books.
          ...
          <div style={{ position: "relative", flex: "1 1 240px", minWidth: "200px" }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: "10px", border: "1.5px solid #ddd6fe",
                fontSize: "14px", outline: "none", color: "#1e143c",
                background: "#faf8ff", boxSizing: "border-box" as const,
                transition: "border-color 0.15s",
              }}
              onFocus={(e) => (e.target.style.borderColor = "#7c5cbf")}
              onBlur={(e) => (e.target.style.borderColor = "#ddd6fe")}
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" as const }}>
            ...
            <select
              ...
              style={{
                ...
                border: "1.5px solid #ddd6fe", background: "#faf8ff",
                color: "#7c6f99", fontSize: "13px", fontWeight: 600, cursor: "pointer",
              }}
            >
      ...
      <footer style={{
        marginTop: "60px", borderTop: "1px solid #ede8f7",
        padding: "28px 24px", textAlign: "center" as const,
        color: "#b0a8c8", fontSize: "13px", background: "#fff",
      }}>
